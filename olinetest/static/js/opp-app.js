...
$(function () {
    if (!getlogin()) {//过滤登录页面
        ...
        var urlArr=["/setting","/admin","/examinee/singlechoice","/multiplechoice","/judgechoice","/examinee/maketest","/examineebatch","/organizationexa","score_exam","score_examinee","/analyticsexam","analytics_examinee"]
        if(cookieUse.actstatus=="999999"){
    ...
    $("#index_admin_url").attr("href", "/admin");
